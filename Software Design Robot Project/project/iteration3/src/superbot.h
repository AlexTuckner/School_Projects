...
class SuperBot : public ArenaMobileEntity {
  ...
  */
  ...
  double get_default_speed() {return default_speed_;}

  double get_proximity_range() const {
    return sensor_proximity_superbot_.get_range();
  }

  double get_proximity_fov() const {
    return sensor_proximity_superbot_.get_field_of_view();
  }

  SensorTouch* get_sensor_t() { return &sensor_touch_superbot_; }
  SensorProximity* get_sensor_p() { return &sensor_proximity_superbot_; }
  SensorEntityType* get_sensor_e() { return &sensor_entity_type_superbot_; }
