...
class GraphicsArenaViewer : public GraphicsApp {
 public:
  ...
  /**
   * \fn void OnLeftMouseDown(int x, int y) override;
  ...
  /**
   * \fn void OnLeftMouseUp(int x, int y) override;
  ...
  /**
   * \fn void OnRightMouseDown(int x, int y) override;
  ...
  /**
   * \fn void OnRightMouseUp(int x, int y) override;
  ...
  /**
   * \fn void OnKeyDown(const char *c, int modifiers) override;
  ...
  /**
   * \fn void OnKeyUp(const char *c, int modifiers) override;
  ...
  /**
   * \fn void OnSpecialKeyDown(int key, int scancode, int modifiers) override;
  ...
  /**
   * \fn void OnSpecialKeyUp(int key, int scancode, int modifiers) override;
  ...
  /**
   * \fn void DrawUsingNanoVG(NVGcontext *ctx) override;
 ...
 private:
  /**
   * \fn void DrawPlayer(NVGcontext *ctx, const class Player* const player);
  ...
  /**
   * \fn void DrawObstacle(NVGcontext *ctx,
  ...
  /**
   * void DrawSuperbot(NVGcontext *ctx, const class Robot* const robot);
  ...
  /**
   * \fn void DrawHomeBase(NVGcontext *ctx, const class HomeBase* const home);
  ...
  nanogui::FormHelper *new_gui;
  double last_dt;
  double player_battery_level;
  int num_Wins;
  int num_Losses;
  std::string game_status;
  std::string temp_game_status;
  const struct arena_params* const initial_arena_params_;
